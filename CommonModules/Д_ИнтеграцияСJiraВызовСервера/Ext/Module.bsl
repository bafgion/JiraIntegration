...
Функция ПолучитьСопоставленныеПараметры(ПараметрыЗапроса) Экспорт
	...
	|ГДЕ
	|	Д_НастройкиШаблоновОтправкиСопоставленныеПараметры.Ссылка.ТипОбъекта = &ТипОбъекта
	|	И Д_НастройкиШаблоновОтправкиСопоставленныеПараметры.Ссылка.ИмяОбъекта = &ИмяОбъекта
	|	И Д_НастройкиШаблоновОтправкиСопоставленныеПараметры.Ссылка.ТипЗапроса = &ТипЗапроса
	|	И Д_НастройкиШаблоновОтправкиСопоставленныеПараметры.Ссылка.ВызываемыйМетод = &ВызываемыйМетод";
